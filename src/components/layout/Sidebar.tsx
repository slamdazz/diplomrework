...
import { Home, User, BookOpen, MessageCircle, Users, Shield, LogOut } from "lucide-react"
      ...
      <nav className="flex-1 space-y-1">
        ...
        {(isAdmin || isModerator) && (
          <div className="pt-4 mt-4 border-t border-gray-200">
            <h3 className="px-3 text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">Управление</h3>

            {isAdmin && (
              <>
                <Link
                  to="/admin/dashboard"
                  className={`flex items-center px-3 py-2 rounded-md ${isActive("/admin/dashboard") ? "bg-blue-50 text-blue-600" : "text-gray-700 hover:bg-gray-100"}`}
                >
